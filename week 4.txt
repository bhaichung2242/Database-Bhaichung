...
--may be added to the existing relational table
--Using ALTER statement

ALTER TABLE sites
ADD (classroom classroom_varray_type);

--Steps to Creating a Nested Table
